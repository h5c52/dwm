...
static const char *fonts[]          = { "Ubuntu Mono Nerd Font:pixelsize=14:antialias=true:autohint=true" };
static const char dmenufont[]       = "Ubuntu Mono Nerd Font:pixelsize=14:antialias=true:autohint=true";
